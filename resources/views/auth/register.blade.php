            ...
            <div class="form-outer text-center d-flex align-items-center">
                <div class="form-inner">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group-material">
                            <input id="register-phone" type="text" name="phone_number" required
                                class="input-material">
                            <label for="register-phone" class="label-material">{{ trans('file.Phone Number') }}
                                *</label>
                        </div>
                        <div class="form-group-material">
                            <input id="register-company" type="text" name="company_name" class="input-material">
                            <label for="register-company"
                                class="label-material">{{ trans('file.Company Name') }}</label>
                        </div>
                        <div class="form-group-material">
                            <select name="role_id" id="role-id" required class="selectpicker form-control"
                        ...
                        <div id="customer-section">
                            ...
                            <div class="form-group-material">
                                ...
                                <label for="customer-tax-number"
                                    class="label-material">{{ trans('file.Tax Number') }}</label>
                            </div>
                            <div class="form-group-material">
                                <input id="customer-address" type="text" name="address"
                                    class="input-material customer-field">
                                <label for="customer-address" class="label-material">{{ trans('file.Address') }}
                                    *</label>
                            </div>
                            <div class="form-group-material">
                                <input id="customer-city" type="text" name="city"
                                    class="input-material customer-field">
                            ...
                            <div class="form-group-material">
                                <input id="customer-postal" type="text" name="postal_code"
                                    class="input-material">
                                <label for="customer-postal"
                                    class="label-material">{{ trans('file.Postal Code') }}</label>
                            </div>
                            <div class="form-group-material">
                                <input id="customer-country" type="text" name="country" class="input-material">
                                <label for="customer-country"
                                    class="label-material">{{ trans('file.Country') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group-material">
                            <input id="password-confirm" type="password" name="password_confirmation" required
                                class="input-material">
                            <label for="password-confirm" class="label-material">{{ trans('file.Confirm Password') }}
                                *</label>
                        </div>
                        <input id="register" type="submit" value="Register" class="btn btn-primary">
                    </form>
                    <p>{{ trans('file.Already have an account') }}? </p><a href="{{ url('login') }}"
                        class="signup">{{ trans('file.LogIn') }}</a>
                </div>
            </div>
        </div>
    </div>
