...
class AdjustmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            if( isset($data['stock_count_id']) ){
                $lims_stock_count_data = StockCount::lockForUpdate()->find($data['stock_count_id']);
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::beginTransaction();
        try {
            $lims_adjustment_data = Adjustment::lockForUpdate()->find($id);
            $lims_product_adjustment_data = ProductAdjustment::where('adjustment_id', $id)->get();
            $product_id = $data['product_id'];
            $qty = $data['qty'];
            $action = $data['action'];
            ...
            foreach ($lims_product_adjustment_data as $key => $product_adjustment_data) {
                ...
                $lims_product_data = Product::lockForUpdate()->find($product_adjustment_data->product_id);
                $lims_product_warehouse_data = Product_Warehouse::where([
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect('qty_adjustment')->with('not_permitted', 'Something went wrong! '.$e->getMessage());
        }
