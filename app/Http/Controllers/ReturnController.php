...
class ReturnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $lims_customer_data = Customer::lockForUpdate()->find($data['customer_id']);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $lims_return_data = Returns::lockForUpdate()->find($id);
            $lims_product_return_data = ProductReturn::where('return_id', $id)->get();
            ...
            foreach ($lims_product_return_data as $key => $product_return_data) {
                ...
                $lims_product_data = Product::lockForUpdate()->find($product_return_data->product_id);
                if($lims_product_data->type == 'combo'){
                    $product_list = explode(",", $lims_product_data->product_list);
                    $qty_list = explode(",", $lims_product_data->qty_list);
                ...
                elseif($product_return_data->sale_unit_id != 0){
                    ...
                    if($product_return_data->variant_id) {
                        $lims_product_variant_data = ProductVariant::select('id', 'qty')->FindExactProduct($product_return_data->product_id, $product_return_data->variant_id)->lockForUpdate()->first();
            ...
            foreach ($return_id as $id) {
                ...
                foreach ($lims_product_return_data as $key => $product_return_data) {
                    ...
                    elseif($product_return_data->sale_unit_id != 0){
                        ...
                        if($product_return_data->variant_id) {
                            $lims_product_variant_data = ProductVariant::select('id', 'qty')->FindExactProduct($product_return_data->product_id, $product_return_data->variant_id)->lockForUpdate()->first();
                            $lims_product_warehouse_data = Product_Warehouse::FindProductWithVariant($product_return_data->product_id, $product_return_data->variant_id, $lims_return_data->warehouse_id)->lockForUpdate()->first();
                            $lims_product_variant_data->qty -= $quantity;
                            $lims_product_variant_data->save();
                        }
                        else
                            $lims_product_warehouse_data = Product_Warehouse::FindProductWithoutVariant($product_return_data->product_id, $lims_return_data->warehouse_id)->lockForUpdate()->first();
